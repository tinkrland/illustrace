...
aimlapi (`stealth/union-alpha`, liat's key, added and retired 2026-09-20): the
cloaked free slot unmasked itself before a single live completion — every
request now returns "this model was unbiased's pareto", and no pareto/unbiased
listing exists in the catalog. the cautionary data point stands as written:
cloaked models have a testing-period shelf life measured in days, plus daily
key quotas on the free tier. if a new stealth model appears there, treat it as
a lottery ticket, not a ladder rung.
